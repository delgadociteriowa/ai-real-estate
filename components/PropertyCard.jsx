  ...
  return (
    <div className='rounded-xl shadow-md relative'>
      ...
      <div className='p-4'>
        ...
        <h3 className='absolute top-[10px] right-[10px] bg-white px-4 py-2 rounded-lg text-cyan-500 font-bold text-right md:text-center lg:text-right'>
          {getRateDisplay()}
        </h3>
        ...
        <div className='flex justify-center gap-4 text-green-900 text-sm mb-4'>
          ...
          <p>
            <FaBath className='md:hidden lg:inline' /> Monthly
          </p>
        </div>
